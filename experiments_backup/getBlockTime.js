...
for(var i=0; i<list.length; i++){
  //console.log(list[i]["txHash"]);
  web3.eth.getTransactionReceipt(list[i]["txHash"],callback1);


}


function callback1(txHash){
...
//     var txToSend = 3;  //number devices to register
//
...
//         if (!err){
//           //var hashtime = new Date(Date.UTC(year, month, day, hour, minute, second));
//           var hashtime = new Date();
//           hashtime.setTime( hashtime.getTime() + hashtime.getTimezoneOffset()*60*1000 );
//
//           var entry = {txHash:hash,timeSent:hashtime,blockHash:"",blockTimeStamp:""};
//           console.log(JSON.stringify(entry) + ',');
//           //console.log('{"Hash":, '+ hash + ', '"Sent"', " + hashtime.getHours()+':'+hashtime.getMinutes()+':'+hashtime.getSeconds()+'.'+hashtime.getMilliseconds() ); // "0x7f9fade1c0d57a7af66ab4ead79fade1c0d57a7af66ab4ead7c2c2eb7b11a91385"
//         }
//         else {
//           console.log(err);
//         }
